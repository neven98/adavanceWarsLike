...
public class RedTank extends Unity {
    ...
    public static void crea(){
        tex = new Texture(Gdx.files.internal("RedTankAni.png"));
    ...
    public static void create(){
        ...
        if (Moved & (Gdx.input.isButtonPressed(Input.Buttons.LEFT))){
            if ((Tile.map[Gdx.input.getX()/64][(1025-Gdx.input.getY())/64] == 3) &  ((checkX() || checkY()) && (checkXs() || checkYs()) && (checkXt() || checkYt()) && (checkXvr()  || checkYvr()) && (checkXv() || checkYv()) )){
    ...
    public static void DrawUnit(SpriteBatch batch, BitmapFont font){
        font.draw(batch, ""+RedTank.life +"", posxFont, posyFont);
