...
public class RedCar extends Unity {
    ...
    public static int life =125;
    public static int att =25;
    public static int def =15;
    public static boolean dead = false;
    public static float  stateTime;
    public static int depla = 5;
    ...
    public static void crea(){
        ...
        tex = new Texture(Gdx.files.internal("RedCar.png"));
    ...
    public static void create(){
        ...
        if (Moved & (Gdx.input.isButtonPressed(Input.Buttons.LEFT))){
            if ((Tile.map[Gdx.input.getX()/64][(1025-Gdx.input.getY())/64] == 3) &  (checkX() || checkY()) && (checkXt() || checkYt()) && (checkXs() || checkYs()) && (checkXv()||checkYv()) && (checkXsd() || checkYsd()) ){
    ...
    public static void DrawUnit(SpriteBatch batch, BitmapFont font){
        font.draw(batch, ""+RedCar.life +"", posxFont, posyFont);
